...
**Поля:**
- `_phoneInput: HTMLElement` - DOM-элемент текстового поля для ввода телефона.
- `_emailInput: HTMLButtonElement` - DOM-элемент текстового поля для ввода электронной почты.
- 
